...
void altera_registro(void){
    FILE        * Arqpremio;
    reg_premio  valor_do_premio,novovalor;
    int         numero_registro=0,registro_alterado;
    ...
    printf("\nDigite o registro que você deseja alterar: ");
    scanf("%i",&registro_alterado);
   ...
   while ( !feof(Arqpremio) )
    {
        ...
        if(registro_alterado == numero_registro){
            fseek(Arqpremio, (registro_alterado-1)* sizeof(novovalor),SEEK_SET );
            printf("\nRegistro: %i",numero_registro);
             printf("\n Digite o novo valor para o registro %i: ",numero_registro);
            scanf("%f",&novovalor.valor_premio);
            fwrite ( &novovalor, sizeof(novovalor), 1, Arqpremio );
            break;
            }
    }
